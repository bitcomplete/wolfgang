...
- The junior is the worst-placed person to absorb divergence: the practitioner literature shows juniors reliably catch "it doesn't run" and miss workflow-fit and maintainability failures, and over-trust confident agents (`undefined/notes/research-practitioner-lessons.md` §4). A senior amortizes divergence with experience; a junior cannot.
